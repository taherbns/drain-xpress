...
export const ContactForm: React.FC = () => {
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="bg-skyblue/80 md:w-1/3 p-8 text-white flex flex-col justify-between">
                <div>
                  ...
                  <p className="mb-8 text-white/90">{t("contactDesc")}</p>
  ...
  <select
    ...
    onChange={handleChange}
    required
    className="w-full bg-white/20 border border-white/30 text-white placeholder-white/60 rounded px-3 py-2 transition duration-200 focus:outline-none focus:ring-2 focus:ring-sky-400"
  >
    <option value="" disabled className="text-white/60">
      Choisissez une option
    </option>
    <option value="expert" className="text-white/60">
      Parler à un expert dès maintenant
    </option>
    <option value="camera" className="text-white/60">
      Réserver une inspection caméra
    </option>
    <option value="prevention" className="text-white/60" >
      Planifier un entretien préventif
    </option>
    <option value="débouchage" className="text-white/60">
      Débouchage de drain
    </option>
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <Input
                        ...
                        onChange={handleChange}
                        className="bg-white/20 border text-white placeholder-white/60"
                      />
